...
namespace BulkEditor.Infrastructure.Utilities
{
    public static class OpenXmlHelper
    {
        ...
        /// <summary>
        /// Internal method for updating hyperlink text
        /// </summary>
        ...
        /// <summary>
        /// Replaces text in a run
        /// </summary>
        public static void ReplaceTextInRun(Run run, string oldText, string newText)
        {
            ReplaceTextInRunInternal(run, oldText, newText);
        }

        /// <summary>
        /// Internal method for replacing text in a run
        /// </summary>
